    ...
    function Flash(root, opts, conf) {
        ...
        if (f.isSupported(opts.version)) {
            ...
            if (!root.innerHTML.replace(/\s/g, '')) {
                ...
                root.innerHTML =
                    "<h2 style='display:inline;'>该功能需要安装Flash播放器，请点击右侧图标下载安装：</h2>" +
                    "<img style='cursor:pointer;' src='http://" + window.location.host + "/assets/vendors/FlexPaper/get_flash_player.gif' alt='下载安装Flash播放器' />";
                ...
                if (root.tagName == 'A') {
                    ...
                    root.onclick = function() {
                        location.href = 'http://' + window.location.host + '/assets/vendors/FlexPaper/flashplayer.exe';
                    };
                }
            }
